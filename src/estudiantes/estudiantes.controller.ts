...
// COMENTADO COMPLETO: Bachillero pidió eliminar la función de gestionar
// estudiante individual (ya no existe esa entidad de cliente; ahora es
// Curso). Se comenta todo el controller, no se borra, por si se reactiva
// para otra institución que sí maneje estudiante individual.
//
// @ApiTags('Estudiantes')
