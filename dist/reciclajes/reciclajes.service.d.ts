...
export declare class ReciclajesService {
    ...
    constructor(reciclajeRepository: Repository<Reciclaje>, cursoRepository: Repository<Curso>, usuarioRepository: Repository<Usuario>, historialRepository: Repository<HistorialPuntos>, auditoriaService: AuditoriaService, dataSource: DataSource);
